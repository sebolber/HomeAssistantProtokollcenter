...
# DPT-spezifische Wertbereiche fuer den VALUE_OUT_OF_RANGE-Detector
# (Iter 13). Werte konsolidiert aus der KNX-Datapoint-Type-Spec
# (support.knx.org/hc/en-us/articles/115001133744-Datapoint-Type) plus
